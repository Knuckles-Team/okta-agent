...
name: okta-starter
description: >-
  Okta API + MCP Server + A2A Server Use when working with Okta via this package's MCP
...
Starter skill for the **Okta** package. Use the `mcp-client` universal skill
